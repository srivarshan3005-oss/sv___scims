...
import { adminComplaintAPI } from '../../api';
...
export default function AdminComplaintView() {
    ...
    /**
     * Wrap fetchComplaint in useCallback so it is stable across renders
     * and can be safely listed in the useEffect dependency array without
    ...
    const handleStatusUpdate = async (e) => {
        ...
        setFormError('');
        try {
            const res = await adminComplaintAPI.updateStatus(id, {
    ...
    if (loading) return (
        <Layout role="admin" title="Complaint Details">
    ...
    if (error && !complaint) return (
        <Layout role="admin" title="Complaint Details">
            ...
            <Link to="/admin/complaints" className="btn btn-outline-secondary">
    ...
    return (
        <Layout role="admin" title={`Complaint #${id}`} subtitle="Review and update status">
            {success && (
                        ...
                        <div className="card-body">
                            ...
                            <div style={{ background: '#f8fafc', borderRadius: '0.5rem', padding: '0.75rem' }}>
                                ...
                                <div className="d-flex align-items-center gap-2 mb-1">
                                    <div style={{ width: 32, height: 32, borderRadius: '50%', background: '#2563eb', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.9rem', flexShrink: 0 }}>
