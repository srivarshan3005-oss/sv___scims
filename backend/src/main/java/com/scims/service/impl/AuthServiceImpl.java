...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtResponse login(LoginRequest request) {
        ...
        // Department name isn't on UserDetailsImpl (only the id is, to keep
        // the JWT principal small) — look it up once here for the response
        // the frontend uses to label "My Department" on the Sub Admin UI.
        String departmentName = null;
        if (userDetails.getDepartmentId() != null) {
            departmentName = userRepository.findById(userDetails.getId())
